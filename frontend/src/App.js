      ...
      <div className="login-panel">
        <div className="login-panel-content">
          ...
          <div className="login-panel-features">
            {[
              { icon: <Icons.UserCheck />, text: 'Fast Check-In & Check-Out' },
              { icon: <Icons.Grid />, text: 'Real-Time Room Management' },
              { icon: <Icons.DollarSign />, text: 'Payments & Revenue Tracking' },
              { icon: <Icons.Clipboard />, text: 'Housekeeping Coordination' },
            ].map((f, i) => (
        ...
        <div className="login-card">
          <div className="login-header">
            <div className="login-logo">
              <img src="/hositality.png" alt="Logo" style={{ width: '34px', height: '34px', objectFit: 'contain' }} />
            </div>
          ...
          <p className="login-footer-text">Contact your administrator if you need access.</p>
        </div>
      </div>
    </div>
  );
